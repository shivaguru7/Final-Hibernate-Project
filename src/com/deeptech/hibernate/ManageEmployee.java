...
public class ManageEmployee {
	...
	public static void main(String[] args) {
		...
		Integer emp1 = ME.addEmployee("Shalini","S","Developer",25000);
		Integer emp2 = ME.addEmployee("Sai","Krishna","Admin",35000);
		Integer emp3 = ME.addEmployee("Naveen","Kumar","Developer",35000);
		Integer emp4 = ME.addEmployee("Lokesh","M","Exe",25000);
